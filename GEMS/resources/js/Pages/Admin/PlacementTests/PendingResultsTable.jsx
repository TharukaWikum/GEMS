...
// const PendingResultsTable = ({ tests }) => (
//     <div className="mb-8">
//         <h3 className="text-xl font-semibold mb-3">Pending Results Tests</h3>
  ...
  <section className="max-w-7xl mx-auto mb-8 px-4">
    <div className="bg-white rounded-xl shadow-md p-6">
      <div className="flex items-center gap-2 mb-4">
        <HourglassBottomIcon className="text-yellow-600" />
        <h3 className="text-xl font-bold text-gray-800">Pending Results Tests</h3>
      </div>
