...
import AuthenticatedLayout from "@/Layouts/AuthenticatedLayout";
import StudentDetails from "@/Pages/Users/Students/Pages/StudentDetails";
import PlacementTestScheduler from "./Components/PlacementTestScheduler";
import CourseApplicationSection from "./Components/CourseApplicationSection";
import InstallmentPaymentSection from "./Components/InstallmentPaymentSection";
import ExamResultsSection from "./Components/ExamResultsSection";
import CourseApplicationStatusTable from "./Components/CourseApplicationStatusTable";
...
export default function StudentProfile({
    ...
    return (
        ...
        >
            <div className="mt-3 p-4 max-w-7xl mx-auto bg-white shadow rounded space-y-6">
                {/* Student Info */}
                <StudentDetails student={student} />

                {/* Placement Test Scheduler */}
                {(student.student_status === "registered" ||
                    student.student_status === "placement_scheduled") && (
                ...
                {/* Staff Installment Payment Form */}
                ...
                {/* Exam Results */}
                <ExamResultsSection examResults={examResults} />

                {/* Applications Table */}
                <CourseApplicationStatusTable applications={applications} />
